<template>
  <div class="self-center xl:mt-[35vh] lg:mt-80 md:mt-12 mt-12 text-right flex-col flex relative">
    <div class="arrowMenu md:top-[10vh] md:right-[80vh]">
      <i
        class="fab fa-twitter transition-all ease-in-out text-third dark:text-white hover:text-dark mb-3  "
        ><span
          class="lg:text-4xl text-2xl font-light block lg:inline-block align-text-top rotate-12"
          style="font-family: Rubik Scribble"
          >Menu</span
        ></i
      >
      <div class="arrow relative opacity-60 -scale-x-100 left-0 -bottom-10 inline-flex h-10 w-10 -rotate-[-30deg]  transition-all ease-in-out text-third dark:text-white hover:text-dark mb-3">
