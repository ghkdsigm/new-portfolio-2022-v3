<template>
  <div
    class="picWrapper grid 2xl:grid-cols-4 xl:grid-cols-3 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-2 gap-0"
  >
    <div class="flex items-center h-80 overflow-hidden">
      <img
    ...
    <div class="flex items-center h-80 overflow-hidden">
      <img
        ...
        class="object-cover object-center h-full w-full"
        alt="유벤투스 vs 팀k리그 친선경기"
      />
    </div>
    <!-- 아이템베이 -->
    <div class="flex items-center h-80 overflow-hidden">
      <img
        src="@/assets/images/00.jpg"
        class="object-cover object-center h-full w-full"
        alt="아이템베이 조직활성화"
      />
    </div>
