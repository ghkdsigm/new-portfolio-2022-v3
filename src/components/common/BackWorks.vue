<template>
  <div class="lg:mt-12 mt-0">
    <router-link to="/works" class="flex items-center" style="font-family: 'Archivo Black', sans-serif;">
      ...
      <svg version="1.1" class="w-5 dark:fill-white fill-blue-900 mr-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
      <metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
      ...
      <span class="dark:text-white dark:hover:text-slate-300 text-blue-900 hover:text-blue-700 font-bold lg:text-xl text-base">Back</span>
    </router-link>
  </div>
</template>
