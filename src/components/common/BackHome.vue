<template>
  <div class="mt-12">
    <router-link to="/" class="flex items-center" style="font-family: 'Archivo Black', sans-serif;">
      ...
      <svg version="1.1" class="w-5 dark:fill-yellow-500 fill-blue-900 mr-2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" enable-background="new 0 0 1000 1000" xml:space="preserve">
      <metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
      ...
      <span class="dark:text-yellow-500 dark:hover:text-yellow-300 text-blue-900 hover:text-blue-700 font-bold text-xl">Home</span>
    </router-link>
  </div>
</template>
