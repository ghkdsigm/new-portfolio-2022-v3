<template>
	<div class="lg:mt-4 block dark:text-secondary text-secondary-dark text-left">
		<h4 class="lg:text-xl text-base mb-10 font-light">
			...
			실무에 활용하였고, 또 계속해서 배움을 실천하고 있는 언어이자 도구들입니다.<br />
			현재 사용 중인 기술뿐만 아니라, 컴퓨터 공학, 웹 브라우저 구조, 알고리즘 등 이론적 기반에 대한 학습도 꾸준히 병행하고 있으며,<br />
			이를 통해 더욱 넓고 깊이 있는 문제 해결 역량과 업무 수행 능력을 기르고 있습니다.<br /><br />

			특히, Cursor AI와 Claude 등의 생성형 AI 도구를 적극 활용하여 개발에 접목하고 있으며,<br />
			단순한 반복 업무 자동화뿐만 아니라 실제 코드 품질 향상과 학습의 도구로서도 능동적으로 활용 중입니다.<br /><br />

			다가오는 AI 시대에 맞춰, **바이브 코딩(Vibe Coding)**을 통해 코드의 흐름과 의도를 함께 이해하며,<br />
			기술을 맥락 속에서 유연하게 적용하는 개발자로서의 성장을 실천하고 있습니다.<br /><br />

			앞으로도 변화하는 기술 환경에 민감하게 대응하며, 스스로 학습하고 발전하는 자세로 끊임없이 진화해 나가겠습니다.
		</h4><br />
